...
class DirectBinaryEdge : public g2o::BaseBinaryEdge<1 , double , g2o::VertexSE3Expmap , g2o::VertexPointXYZ>{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW

        //Default Constructor.
        DirectBinaryEdge(): g2o::BaseBinaryEdge<1 , double , g2o::VertexSE3Expmap , g2o::VertexPointXYZ>() {}
        
        //Constructor.
        // DirectBinaryEdge(float nFx , float nFy , 
        //                 float nCx , float nCy , cv::Mat * pImage):g2o::BaseBinaryEdge<1 , double , g2o::VertexSE3Expmap , g2o::VertexPointXYZ>()
        //                 {
        ...
        virtual void computeError(){
            ...
            //The 3d point vertex.
            const g2o::VertexPointXYZ * pPointVertex = static_cast<const g2o::VertexPointXYZ *>(_vertices[1]);
